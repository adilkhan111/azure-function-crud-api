...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        container.delete_item(item=req_body.get('id'), partition_key=req_body.get('department'))
        response = {'message':'Record deleted successfully'}
        status_code = 200
            
        # if req_body.get('id') and req_body.get('department'):
    except exceptions.CosmosResourceNotFoundError as rnfe:
        logging.info('==========ERROR IN CREATING EMPLOYEES=11======.%r',rnfe)
